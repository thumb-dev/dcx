    ...
    $scope.open4 = function (size) {
        ...
        function contentmodal4open() {
            return [
                ...
                '<iframe width="560" height="315" src="https://www.youtube.com/embed/4TptTP0oQCI?autoplay=1&loop=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
                '</p>',
                '</div>',
                //Optional footer
