...
function imagelightboxtemplate () {
    return [
        ...
        '<div class="btn-group">',
        '<a class="btn btn-xs btn-default" ng-click="Lightbox.prevImage()" style="border-bottom-right-radius: 0;border-top-right-radius: 0"><i class="fa fa-chevron-left"></i> Previous</a>',
        '<a ng-href="{{Lightbox.imageUrl}}" target="_blank" class="btn btn-xs btn-default" title="Open in new tab">Open image in new tab</a>',
        '<a class="btn btn-xs btn-default" ng-click="Lightbox.nextImage()" style="border-bottom-right-radius: 24px;border-top-right-radius: 24px">Next <i class="fa fa-chevron-right"></i></a>',
        '<a class="btn btn-xs btn-default pull-right" aria-hidden="true" ng-click="$dismiss()" style="border-bottom-left-radius: 24px;border-top-left-radius: 24px;">Close <i class="fa fa-times"></i></a>',
        '</div>',
        '</div>',
        '<div class="lightbox-image-container">',
        '<div class="lightbox-image-caption"><span>{{Lightbox.imageCaption}}</span></div>',
        '<img lightbox-src="{{Lightbox.imageUrl}}" alt="" style="width: 500px; height: 500px;">',
        '</div>',
        '</div>',
        '</div>'
    ].join('');
